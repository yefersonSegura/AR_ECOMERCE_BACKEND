...
{
    public interface IPromotionsApplication
    {
        Task<ResponseDto<List<PromotionsDto>>> GetPromotions(int idPromotions);
        Task<ResponseDto<List<PromotionsDto>>> GetPromotionsByProductId(int idProduct);
